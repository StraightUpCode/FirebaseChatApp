...
public class ChatRoomFragment extends Fragment {
    ...
    // Cuando se crea la vista del Framento
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.chat_room_layout,container, false);
        Bundle args = getArguments();
        tipoChat = args.getString("TIPO_CHAT");
        chatRoomName = args.getString("CHAT_ROOM");
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        messageContent = view.findViewById(R.id.messageEditText);
        messageRecyclerView = view.findViewById(R.id.chatRoomRecycler);
    ...
    public void setUpRecyclerView(){
        ...
        FirestoreRecycler = new FirestoreRecyclerAdapter<Message, MessageViewHolder>(options){
            @Override
            protected void onBindViewHolder(@NonNull ChatRoomFragment.MessageViewHolder holder, int position, @NonNull Message model) {
            ...
            @NonNull
            @Override
            public ChatRoomFragment.MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.messate_item,parent,false);
                return new ChatRoomFragment.MessageViewHolder(view);
            }
        };
